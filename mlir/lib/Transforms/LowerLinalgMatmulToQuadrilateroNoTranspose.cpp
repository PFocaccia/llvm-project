//===- LowerLinalgMatmulToQuadrilateroNoTranspose.cpp --------------------===//
//
...
struct LowerLinalgMatmulToQuadrilateroNoTransposePass
    : public LowerLinalgMatmulToQuadrilateroNoTransposeBase<
          LowerLinalgMatmulToQuadrilateroNoTransposePass> {
...
std::unique_ptr<Pass> createLowerLinalgMatmulToQuadrilateroNoTransposePass() {
  return std::make_unique<LowerLinalgMatmulToQuadrilateroNoTransposePass>();
}
} // namespace mlir